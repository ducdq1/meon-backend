...
public class BillController {
    ...
    public ResponseEntity<Object> updateTable(@RequestBody CreateBillRequest request, @PathVariable Integer billId, @AuthenticationPrincipal Authentication authentication) {
        Object result;
        try {
