...
/*     */ public class CommonDataBaseRepository
    ...
    public List<? extends Object> getListData_Core(StringBuilder queryString, List<Object> arrParams, Integer startPage, Integer pageLoad) {
        ...
        if (startPage != null && pageLoad != null) {
            /*  50 */
            query.setFirstResult(startPage.intValue()).setMaxResults(startPage.intValue() + pageLoad.intValue());
            /*     */
        }
        /*  52 */
        List<? extends Object> objectList = query.getResultList();
        /*  53 */
    ...
    public List<? extends Object> getListData(StringBuilder queryString, List<Object> arrParams, Integer startPage, Integer pageLoad, Class<?> classOfT) {
        ...
        try {
            ...
            try {
                ...
                /*  78 */
                if (strDriverName.contains("oracle"))
                    /*     */ {
                    /*  80 */
            ...
            if (databaseIsOracle && startPage != null && pageLoad != null) {
                /*     */
                /*  88 */
                String strVersionOracle = FunctionCommon.getPropertiesValue("oracle.version");
                /*  89 */
                if (strVersionOracle.trim().equals("11")) {
                    ...
                    sqlPage.append(" ) a ) ");
                    /*  93 */
                    sqlPage.append(String.format(" WHERE r__ > %d", new Object[]{startPage}));
                    /*  94 */
                    sqlPage.append(String.format(" and r__ <= %d", new Object[]{Integer.valueOf(startPage.intValue() + pageLoad.intValue())}));
                    /*     */
                } else {
                    /*  96 */
                    ...
                    sqlPage.append(" ) a ");
                    /*  99 */
                    sqlPage.append(String.format("  OFFSET %d ROWS FETCH NEXT %d ROWS ONLY ", new Object[]{startPage, pageLoad}));
                    /*     */
                }
                /*     */
            } else {
            ...
            if (startPage != null && pageLoad != null && !databaseIsOracle) {
                /* 113 */
                query.setFirstResult(startPage.intValue()).setMaxResults(pageLoad.intValue());
                /*     */
            }
            /* 115 */
    ...
    public List getListDataOriginal(StringBuilder queryString, List<Object> arrParams, Integer startPage, Integer pageLoad) {
        ...
        try {
            /* 136 */
            Boolean databaseIsOracle = Boolean.valueOf(false);
            /*     */
            /*     */
            try {
                /* 139 */
                ...
                if (strDriverName.contains("oracle"))
                    /*     */ {
                    /* 143 */
                    databaseIsOracle = Boolean.valueOf(true);
                    /*     */
                }
                /* 145 */
            } catch (Exception e) {
            ...
            StringBuilder sqlPage = new StringBuilder();
            /* 149 */
            if (databaseIsOracle.booleanValue() && startPage != null && pageLoad != null) {
                /*     */
                /* 151 */
                String strVersionOracle = FunctionCommon.getPropertiesValue("oracle.version");
                /* 152 */
            ...
            /* 175 */
            if (startPage != null && pageLoad != null && !databaseIsOracle.booleanValue()) {
                /* 176 */
                query.setFirstResult(startPage.intValue()).setMaxResults(pageLoad.intValue());
                /*     */
            }
    ...
    public ResultSelectEntity getListDataAndCount(StringBuilder queryString, HashMap<String, Object> hmapParams, Integer startPage, Integer pageLoad, Class<?> classOfT) {
        ...
        try {
            ...
            /* 517 */
            result.setCount(Integer.valueOf(getCountDataInSelect(queryString, hmapParams)));
            /* 518 */
            this.entityManager.close();
            /* 519 */
            return result;
    ...
    public ResultSelectEntity getListDataAndCount(StringBuilder queryString, List<Object> arrParams, Integer startPage, Integer pageLoad, Class<?> classOfT) {
        ...
        try {
            ...
            /* 589 */
            result.setCount(Integer.valueOf(getCountDataInSelect(queryString, arrParams)));
            /* 590 */
            this.entityManager.close();
            /* 591 */
            return result;
    ...
    private int getCountDataInSelect(StringBuilder queryString, HashMap<String, Object> hmapParams) {
        ...
        if (hmapParams != null) {
            ...
            for (Object o : set) {
                ...
                /* 724 */
                query.setParameter(mentry.getKey().toString().toLowerCase(), value);
                /*     */
            }
            /*     */
        }
