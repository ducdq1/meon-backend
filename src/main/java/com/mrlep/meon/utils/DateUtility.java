...
public class DateUtility {
    ...
    public static final String DATETIME_REGEX = "\\d{1,2}:\\d{1,2} \\d{1,2}\\/\\d{1,2}\\/\\d{4}";
    public static final String DATE_FORMAT_PROBLEM = "HH:mm dd/MM/yyyy";
    public static final String DATE_FORMAT_PATTERN = "HH:mm - dd/MM/yyyy";
    ...
    public static Date getDateFromString(String timeS) {
    ...
    public static String getStringDateTimePattern1(Date date) {

        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(DateUtility.DATETIME_FORMAT_STR);
        simpleDateFormat.setLenient(false);
        try {
            return simpleDateFormat.format(date);
        } catch (Exception e) {
    ...
    public static String getStringDateTimePattern2(Date date) {

        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(DateUtility.DATE_FORMAT_PROBLEM);
        simpleDateFormat.setLenient(false);
        try {
            return simpleDateFormat.format(date);
        } catch (Exception e) {
    ...
    public static String getStringDateTimePattern(String date1) {
        try {
            SimpleDateFormat f = new SimpleDateFormat(DateUtility.DATE_FORMAT_NOW2);
            Date date = f.parse(date1);
            return DateUtility.getDateStringFormat(date, DateUtility.DATE_FORMAT_PATTERN);
        } catch (Exception e) {
            LoggingUtils.logVTMException(e);
            return "";
        }
    ...
    public static Date parseSQLDate(String str) {
        return parse(str, DATE_FORMAT_STR);
    }
